...
from aivm.firewall import _effective_bridge_and_gateway, _nft_script, apply_firewall
...
def test_apply_firewall_disabled_skips(monkeypatch) -> None:
    ...
    called = []
    monkeypatch.setattr("aivm.firewall.run_cmd", lambda *a, **k: called.append((a, k)))
